...
import '../../core/designs/theme_data.dart';
import '../../app_entry.dart';

// import '../../base_app/app/app_entry.dart';
// import '../../base_app/core/const/app_colors.dart' as AppTheme;
  ...
  late final List<Map<String, String>> onboardingData = [
    {
      ...
      'description': 'Track, control, and organize your fleet effortlessly.',
    },
    {
      'image': _getImagePath('2'),
      'title': 'Vehicle Information Hub',
      'description': 'Your vehicle info with complete driver journey tracking.',
    },
    {
      'image': _getImagePath('3'),
      'title': 'Track Fleet Activities',
      'description': 'Keep your fleet running smoothly with activity tracking.',
    },
  ];
